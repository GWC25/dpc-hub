...
const DPC_CONFIG = Object.freeze({
  ...
  // ── Supabase (Phase 7 — Hub Lite + supabase-sync.js) ──────
  // These are the non-sensitive publishable/anon credentials — safe to
  // expose client-side. The service role key is NEVER stored here — it
